...
if __name__ == "__main__":
	...
	blabels = [1]*len(pos) + [0]*len(neg)

	manualShuffle = torch.randperm(len(bsequences))
	for i in manualShuffle:
		brainSequences.append(bsequences[i])
		brainLabels.append(blabels[i])
	bsequences = brainSequences
	blabels = brainLabels
	...
	testDataset = MyDataset(bsequences[:7650], blabels[:7650])
