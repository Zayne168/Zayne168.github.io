...
#myFile1 = "dataIN/ENCFF006OSW.bed"
#myFile2 = "dataIN/ENCFF041GGN.bed"
#myFile3 = "dataIN/ENCFF083WON.bed"
#myFile4 = "dataIN/ENCFF522GCK.bed"
#myFile5 = "dataIN/ENCFF985UCI.bed"
myFile6 = "dataIN/Heartmuscle.bed"


myReferenceGenome = "/users/zbonner/ref/hg38.fa.fai"
myFasta = "/users/zbonner/ref/hg38.fa"
...
out1 = "dataOUT2/positive.txt"
out2 = "dataOUT2/negative.txt"
#for file in [myFile1, myFile2, myFile3, myFile4, myFile5]:
for file in [myFile6]:
    with open(file) as f:
        for line in f:
...
#combine files
#beds = [pybedtools.BedTool(f) for f in [myFile1, myFile2, myFile3, myFile4, myFile5]]
beds = [pybedtools.BedTool(f) for f in [myFile6]]
